...
class ParamedicConfig {
    ...
    shouldCleanUpAfterRun () {
        return !this._config.projectDir && this._config.cleanUpAfterRun;
    }
    ...
    getSauceBuildId () {
        return this._config.sauceBuildlId;
    }

    setSauceBuildId (bid) {
        this._config.sauceBuildlId = bid;
    }
    ...
    setProjectDir (projectDir) {
        this._config.projectDir = projectDir;
    }
...
ParamedicConfig.parseFromArguments = function (argv) {
    return new ParamedicConfig({
        ...
        sauceBuildId: argv.sauceBuildId,
