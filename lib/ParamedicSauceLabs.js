...
class ParamedicSauceLabs {
    ...
    getSauceCaps () {
        ...
        if (this.config.getSauceBuildId()) {
            caps.build = this.config.getSauceBuildId();
        }

        switch (this.platformId) {
        case utilities.ANDROID:
            caps.platformName = 'Android';
            caps.appPackage = 'org.elastos.trinity.runtime';
            // caps.appActivity = 'org.elastos.trinity.runtime.MainActivity';
